...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Admin Area - Phạm Chiến</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-dashboard fa-fw"></i> Quản Trị</a>
                    </li>
                    <li>
                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    <form action="" method="POST">
                        <div class="form-group">
                            <label>IdLT</label>
                            <input class="form-control" name="txtIdLoaiTin"  />
                        </div>
                        <div class="form-group">
                            <label>Tên Thể Loại</label>
                            <input class="form-control" name="txtTenLoaiTin"  />
                        </div>
                        <div class="form-group">
                            <label>Tên Không Dấu</label>
                            <input class="form-control" name="txtTenKDLoaiTin"  />
                        </div>
                        <div class="form-group">
                            <label>Thời gian tạo</label>
                            <input class="form-control" name="txtThoiGianTao"  />
                        </div>
